...
try:
    ...
    _SHAGGY_VERSION = "0.0.0"

_APP_VERSION = _SHAGGY_VERSION
_BOT_VERSION = _SHAGGY_VERSION
_YUANBAO_INSTANCE_ID = str(SHAGGY_INSTANCE_ID)  # single source: yuanbao_proto.SHAGGY_INSTANCE_ID
