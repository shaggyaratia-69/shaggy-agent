"""
Email platform adapter for the Shaggy gateway.

Allows users to interact with Shaggy by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Shaggy Agent")
        ...
        msg_id = f"<shaggy-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
