...
Config: ~/.shaggy/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.shaggy/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_shaggy_home()`` helper (SHAGGY_HOME-aware and
...
RULES_FILE = get_shaggy_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_shaggy_home() / "feishu_comment_pairing.json"
