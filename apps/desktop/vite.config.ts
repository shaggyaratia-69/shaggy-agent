...
export default defineConfig({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\shaggy\shaggy-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@shaggy/shared': path.resolve(__dirname, '../shared/src'),
  ...
  test: {
    exclude: ['electron/**', 'scripts/**', 'tests/**', 'node_modules/**', 'dist/**', 'release/**'],
