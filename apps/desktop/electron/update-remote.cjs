 ...
 *
 * A public install can end up with `origin=git@github.com:shaggyaratia-69/shaggy-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/shaggyaratia-69/shaggy-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/shaggyaratia-69/shaggy-agent'
