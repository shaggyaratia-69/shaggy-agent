...
import { getSessionMessages, listAllProfileSessions } from '@/shaggy'
import { notifyError } from '@/store/notifications'
import type { SessionInfo, SessionMessage } from '@/types/shaggy'
  ...
  const openArtifact = useCallback(async (href: string) => {
    try {
      if (window.shaggyDesktop?.openExternal) {
        await window.shaggyDesktop.openExternal(href)
      } else {
