...
beforeEach(() => {
  ...
  getGlobalModelOptions.mockResolvedValue({
    providers: [
      { name: 'Nous', slug: 'nous', models: ['shaggy-4', 'shaggy-4-mini'], authenticated: true },
...
describe('ModelSettings', () => {
  it('loads the current main model and lists the full provider universe', async () => {
    ...
    // listed, including unconfigured providers. API-key providers now render
    // their setup control inline after selection rather than inside the menu.
