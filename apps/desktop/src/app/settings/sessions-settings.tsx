...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/shaggy'
...
// / Program Files), which buried any files Shaggy wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.shaggyDesktop` is
    ...
    const settings = window.shaggyDesktop?.settings
