...
import { getShaggyConfigRecord, saveShaggyConfig, type ShaggyGateway } from '@/shaggy'
...
function getServers(config: ShaggyConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveShaggyConfig(nextConfig)
