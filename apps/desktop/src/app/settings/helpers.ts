import type { ShaggyConfigRecord, ToolsetInfo } from '@/types/shaggy'
...
export function getNested(obj: ShaggyConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: ShaggyConfigRecord, path: string, value: unknown): ShaggyConfigRecord {
...
function personalityOptions(config: ShaggyConfigRecord): string[] {
