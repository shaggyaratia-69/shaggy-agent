...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/shaggy'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('shaggy:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('shaggy:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
