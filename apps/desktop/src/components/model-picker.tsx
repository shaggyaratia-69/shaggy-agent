...
import type { ModelOptionProvider, ModelOptionsResponse, ModelPricing } from '@/types/shaggy'
...
export function ModelPickerDialog({
  ...
  // the `shaggy model` CLI picker, which shows the curated list verbatim.
...
function ProviderHeading({ provider }: { provider: ModelOptionProvider }) {
  ...
  // free_tier is only set for Cherries. true → "Free tier", false → "Pro".
  const tierBadge =
