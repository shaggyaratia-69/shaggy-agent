...
const CHERRIES_BLUE = '#0053FD'
const PSYCHE_BLUE = '#1540B1'
const PSYCHE_WARM = '#FFE6CB'

const nousTint = (pct: number) => `color-mix(in srgb, ${CHERRIES_BLUE} ${pct}%, #FFFFFF)`
const nousTintTransparent = (pct: number) => `color-mix(in srgb, ${CHERRIES_BLUE} ${pct}%, transparent)`

/**
 * Cherries — canonical Shaggy desktop identity. The palette keeps the current
...
export const nousTheme: DesktopTheme = {
  name: 'nous',
  label: 'Cherries',
  description: 'Glass neutrals with Cherries blue accents',
  colors: {
    background: '#F8FAFF',
    foreground: '#17171A',
    card: '#FFFFFF',
    ...
    ring: CHERRIES_BLUE,
    midground: CHERRIES_BLUE,
    composerRing: CHERRIES_BLUE,
    destructive: '#C72E4D',
