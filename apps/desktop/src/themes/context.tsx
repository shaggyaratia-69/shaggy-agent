...
const SKIN_KEY = 'shaggy-desktop-theme-v2'
const MODE_KEY = 'shaggy-desktop-mode-v1'
...
const PROFILE_SKINS_KEY = 'shaggy-desktop-profile-themes-v1'
const PROFILE_MODES_KEY = 'shaggy-desktop-profile-modes-v1'
// Last active profile, recorded so the boot-time paint can pick that profile's
// theme before the gateway reports which profile actually launched.
const LAST_PROFILE_KEY = 'shaggy-desktop-active-profile-v1'
...
function applyTheme(theme: DesktopTheme, mode: 'light' | 'dark') {
  ...
  root.dataset.shaggyTheme = skinName
  root.dataset.shaggyMode = rendered
  ...
  window.shaggyDesktop?.setTitleBarTheme?.({
  ...
  if (typo.fontUrl && !INJECTED_FONT_URLS.has(typo.fontUrl)) {
    ...
    link.dataset.shaggyThemeFont = 'true'
...
/** Sync the desktop skin with the active Shaggy backend theme on connect. */
