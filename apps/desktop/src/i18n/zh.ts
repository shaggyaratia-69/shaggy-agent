...
export const zh: Translations = {
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed: '桌面后端拒绝了该请求 (405 Method Not Allowed)。请尝试重启 Shaggy The Agent。',
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverride: '环境变量覆盖',
      intro:
        'Shaggy The Agent 默认会启动自己的本地网关。当你希望此应用控制另一台机器上或可信代理后的现有 Shaggy 后端时，可以使用远程网关。下面可按 profile 指定各自的远程主机。',
      appliesTo: '应用于',
      ...
      savedTitle: '网关设置已保存',
      restartingMessage: 'Shaggy The Agent 将使用已保存设置重新连接。',
  ...
  install: {
    ...
    failedTitle: '安装失败',
    settingUpTitle: '正在设置 Shaggy The Agent',
    finishingTitle: '正在收尾',
    failedDesc:
  ...
  onboarding: {
    headerTitle: '开始设置 Shaggy The Agent',
