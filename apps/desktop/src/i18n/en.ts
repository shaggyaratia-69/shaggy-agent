...
export const en: Translations = {
  ...
  boot: {
    ready: 'Shaggy The Agent is ready',
    ...
    steps: {
      ...
      startingShaggyDesktop: 'Starting Shaggy The Agent…'
    },
    errors: {
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Shaggy The Agent.',
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'Shaggy The Agent starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Shaggy backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      restartingMessage: 'Shaggy The Agent will reconnect using the saved settings.',
  ...
  install: {
    ...
    settingUpTitle: 'Setting up Shaggy The Agent',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Shaggy The Agent",
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Shaggy The Agent v${version}`,
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Shaggy The Agent to use Save Image.',
    restartToSaveImages: 'Restart Shaggy The Agent to save images',
