...
export const en: Translations = {
  ...
  boot: {
    ready: 'Shaggy Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Shaggy settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingShaggyDesktop: 'Starting Shaggy Desktop…'
    },
    errors: {
      backgroundExited: 'Shaggy background process exited.',
      backgroundExitedDuringStartup: 'Shaggy background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Shaggy backend is older than this desktop build and may not work correctly. Update to align them.',
    updateShaggy: 'Update Shaggy',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Shaggy Desktop.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Shaggy defaults?',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Shaggy follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Shaggy checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Shaggy configuration...',
    ...
    gateway: {
      ...
      intro:
        'Shaggy Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Shaggy backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset SHAGGY_DESKTOP_REMOTE_URL and SHAGGY_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Shaggy backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Shaggy backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /shaggy.',
      ...
      restartingMessage: 'Shaggy Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Shaggy ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Shaggy runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
    ...
    toolsets: {
      ...
      ready: 'Ready',
      nousIncluded: 'Included with a Cherries subscription — sign in to Cherries Portal to activate.',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Shaggy desktop' },
    ...
    shaggyActiveSessions: (version, count) => `Shaggy ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@shaggy:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Shaggy environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Shaggy will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Shaggy...',
    placeholderReconnecting: 'Reconnecting to Shaggy…',
    ...
    attachUrlDesc: 'Shaggy will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Shaggy can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Shaggy from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Shaggy will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Shaggy updater will take over in its own window and reopen Shaggy when it’s done.',
    applyingBodyBackend: 'The remote backend is applying the update and will restart. Shaggy reconnects automatically when it’s back.',
    applyingClose: 'Shaggy will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Shaggy needs a one-time install',
    ...
    settingUpTitle: 'Setting up Shaggy Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Shaggy CLI or desktop instance is running. Stop any running Shaggy instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Shaggy installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Shaggy Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Shaggy is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Shaggy…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Shaggy',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Shaggy at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Shaggy connects automatically',
      loopback: 'Opens your browser to sign in — Shaggy connects automatically',
    ...
    authorizeThere: 'Authorize Shaggy there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Shaggy there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid Cherries subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Shaggy Desktop v${version}`,
      ...
      gatewayTitle: 'Shaggy inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Shaggy will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Shaggy is restarting...',
      askRestart: 'Ask Shaggy to restart the server',
      lookingRestart: taskId => `Shaggy is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Shaggy is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Shaggy finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Shaggy could not restart the server.',
      stillWorking:
        'Shaggy is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Shaggy is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Shaggy gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.shaggy/config.yaml). Shaggy won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Shaggy needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Shaggy needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Shaggy Desktop to use Save Image.',
    restartToSaveImages: 'Restart Shaggy Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `shaggy gateway` running?'
    }
  },
