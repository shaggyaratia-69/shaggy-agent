...
const SIDEBAR_PINNED_STORAGE_KEY = 'shaggy.desktop.pinnedSessions'
const SIDEBAR_AGENTS_GROUPED_STORAGE_KEY = 'shaggy.desktop.agentsGroupedByWorkspace'
const SIDEBAR_CRON_OPEN_STORAGE_KEY = 'shaggy.desktop.sidebarCronOpen'
const SIDEBAR_MESSAGING_OPEN_STORAGE_KEY = 'shaggy.desktop.sidebarMessagingOpen'
const SIDEBAR_SESSION_ORDER_STORAGE_KEY = 'shaggy.desktop.sessionOrder'
const SIDEBAR_WORKSPACE_ORDER_STORAGE_KEY = 'shaggy.desktop.workspaceOrder'
const PANES_FLIPPED_STORAGE_KEY = 'shaggy.desktop.panesFlipped'
...
export const SESSION_SEARCH_FOCUS_EVENT = 'shaggy:focus-session-search'
