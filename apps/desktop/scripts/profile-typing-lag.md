...
cd apps/desktop
XCURSOR_SIZE=24 SHAGGY_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/shaggy-typing
# → /tmp/shaggy-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/shaggy-typing.before.heapsnapshot
# → /tmp/shaggy-typing.after.heapsnapshot
```
