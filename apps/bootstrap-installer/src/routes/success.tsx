...
import { launchShaggyDesktop } from '../store'
import { Rocket, AlertCircle } from 'lucide-react'

/*
 * Success screen. SHAGGY AGENT wordmark stays as the visual anchor
 ...
 * Shaggy.exe doesn't exist). We catch the Tauri error and surface it
 * inline rather than silently doing nothing — the previous version
 * had `onClick={() => void launchShaggyDesktop()}` which swallowed
...
export default function Success() {
  ...
  return (
    <div className="shaggy-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>Shaggy is ready</span>
          </span>
          <span aria-hidden="true">Shaggy is ready</span>
        </p>
      ...
      >
        <Rocket size={18} />
        {launching ? 'Launching…' : 'Launch Shaggy'}
      </Button>
