...
_SHAGGY_CORE_TOOLS = [
    ...
    # spawned as a kanban worker (SHAGGY_KANBAN_TASK env set) or the current
...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "enable in `shaggy tools` → X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    },
    ...
    "kanban": {
        "description": (
            ...
            "is spawned by the kanban dispatcher (SHAGGY_KANBAN_TASK env "
    ...
    # ==========================================================================
    # Full Shaggy toolsets (CLI + messaging platforms)
    #
    ...
    "shaggy-cli": {
        ...
        "tools": _SHAGGY_CORE_TOOLS,
        "includes": []
    },

    "shaggy-cron": {
        # Mirrors shaggy-cli so cron's "default" toolset is the same set of
        # core tools users see interactively — then `shaggy tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as shaggy-cli; gated by `shaggy tools`",
        "tools": _SHAGGY_CORE_TOOLS,
        "includes": []
    },
    ...
    "shaggy-email": {
        "description": "Email bot toolset - interact with Shaggy via email (IMAP/SMTP)",
        "tools": _SHAGGY_CORE_TOOLS,
        "includes": []
    },
    ...
    "shaggy-sms": {
        "description": "SMS bot toolset - interact with Shaggy via SMS (Twilio)",
        "tools": _SHAGGY_CORE_TOOLS,
        "includes": []
    },
    ...
    "shaggy-gateway": {
        ...
        "tools": [],
        "includes": ["shaggy-telegram", "shaggy-discord", "shaggy-whatsapp", "shaggy-slack", "shaggy-signal", "shaggy-bluebubbles", "shaggy-homeassistant", "shaggy-email", "shaggy-sms", "shaggy-mattermost", "shaggy-matrix", "shaggy-dingtalk", "shaggy-feishu", "shaggy-wecom", "shaggy-wecom-callback", "shaggy-weixin", "shaggy-qqbot", "shaggy-webhook", "shaggy-yuanbao"]
    }
}
...
def resolve_toolset(name: str, visited: Set[str] = None) -> List[str]:
    ...
    if not toolset:
        # Auto-generate a toolset for plugin platforms (shaggy-<name>).
        # Gives them _SHAGGY_CORE_TOOLS plus any tools the plugin registered
        # into a toolset matching the platform name.
        if name.startswith("shaggy-"):
            platform_name = name[len("shaggy-"):]
            try:
                from gateway.platform_registry import platform_registry
                if platform_registry.is_registered(platform_name):
                    plugin_tools = set(_SHAGGY_CORE_TOOLS)
                    try:
                        from tools.registry import registry
                        plugin_tools.update(
