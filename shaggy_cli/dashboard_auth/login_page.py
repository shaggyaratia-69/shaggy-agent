...
Visual styling mirrors the Cherries and Co Research design system (the
...
``tests/shaggy_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — Shaggy Agent</title>
<style>
...
<body>
<main>
  <div class="brand">Cherries<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Shaggy Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Shaggy Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
