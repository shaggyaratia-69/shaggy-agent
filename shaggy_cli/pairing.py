...
Usage:
    shaggy pairing list              # Show all pending + approved users
    shaggy pairing approve <platform> <code>  # Approve a pairing code
    shaggy pairing revoke <platform> <user_id> # Revoke user access
    shaggy pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle shaggy pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: shaggy pairing {list|approve|revoke|clear-pending}")
        print("Run 'shaggy pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.shaggy/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'shaggy pairing list' to see pending codes.\n")
