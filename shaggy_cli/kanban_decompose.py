...
Invoked by ``shaggy kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Shaggy Agent board.
...
def _profile_author() -> str:
    """Mirror of ``shaggy_cli.kanban._profile_author``."""
    return (
