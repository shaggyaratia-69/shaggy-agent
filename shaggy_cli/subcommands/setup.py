"""``shaggy setup`` subcommand parser.
...
def build_setup_parser(subparsers, *, cmd_setup: Callable) -> None:
    ...
    setup_parser.add_argument(
        "--portal",
        action="store_true",
        help="One-shot Cherries Portal setup: log in via OAuth, pick a Cherries "
        "model, set Cherries as the inference provider, and opt into the Tool "
