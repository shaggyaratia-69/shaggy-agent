...
def build_auth_parser(subparsers, *, cmd_auth: Callable) -> None:
    ...
    auth_add.add_argument("--portal-url", help="Cherries portal base URL")
    auth_add.add_argument("--inference-url", help="Cherries inference base URL")
