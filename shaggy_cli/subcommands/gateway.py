"""``shaggy gateway`` and ``shaggy proxy`` subcommand parsers.
...
def build_gateway_parser(subparsers, *, cmd_gateway: Callable, cmd_proxy: Callable) -> None:
    ...
    gateway_run.add_argument(
        ...
        help=(
            ...
            "if SHAGGY_DASHBOARD is set). Pass --no-supervise to opt out and "
    ...
    proxy_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "to an OAuth-authenticated provider (e.g. Cherries Portal). External "
