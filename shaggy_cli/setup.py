...
_DOCS_BASE = "https://shaggy-agent.nousresearch.com/docs"
...
def _setup_slack():
    ...
    print()
    print_info("   Full guide: https://shaggy-agent.nousresearch.com/docs/user-guide/messaging/slack/")
    print()
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://shaggy-agent.nousresearch.com/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://shaggy-agent.nousresearch.com/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
    print_info("   Open config in your editor:  shaggy config edit")
    print_info("   Open config in your editor:  shaggy config edit")
