"""
Skills configuration for Shaggy Agent.
`shaggy skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.shaggy/config.yaml under:
...
from shaggy_cli.config import cfg_get, load_config, save_config
from shaggy_cli.colors import Colors, color
from shaggy_cli.platforms import PLATFORMS as _PLATFORMS
