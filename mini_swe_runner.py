#!/usr/bin/env python3
"""
SWE Runner with Shaggy Trajectory Format

A runner that uses Shaggy-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Shaggy-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Shaggy-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Shaggy format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Shaggy-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Shaggy-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Shaggy Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Shaggy-Agent's built-in execution environments
    and outputs trajectories in Shaggy-Agent format.
    """
    ...
    def _convert_to_shaggy_format(
        ...
        """
        Convert internal message format to Shaggy trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Shaggy trajectory format
        trajectory = self._convert_to_shaggy_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Shaggy trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Shaggy Trajectory Format")
    print("=" * 60)
