...
def _profile_user_agent() -> str:
    """Return a ``shaggy-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from shaggy_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"shaggy-cli/{_ver}"
    except Exception:
        return "shaggy-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # shaggy-cli UA so the catalog endpoint is reachable.
