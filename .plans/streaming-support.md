# Streaming LLM Response Support for Shaggy Agent
...
```
SHAGGY_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("SHAGGY_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `shaggy_cli/config.py` | 1 | +streaming config defaults |
