#!/usr/bin/env python3
"""Build the Shaggy Model Catalog — a centralized JSON manifest of curated models.
...
Shaggy CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Shaggy release.
...
# Ensure SHAGGY_HOME is set for imports that touch it at module level.
os.environ.setdefault("SHAGGY_HOME", os.path.join(os.path.expanduser("~"), ".shaggy"))

from shaggy_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "shaggy-agent repo",
            "docs": "https://shaggyaratia-69.github.io/shaggy-agent/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
