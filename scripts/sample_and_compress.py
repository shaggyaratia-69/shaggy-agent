...
DEFAULT_DATASETS = [
    ...
    "NousResearch/shaggy-agent-megascience-sft1",
    "NousResearch/Shaggy-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Shaggy-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-shaggy-agent"
]
