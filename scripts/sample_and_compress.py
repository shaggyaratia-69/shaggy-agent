...
DEFAULT_DATASETS = [
    "shaggyaratia-69/swe-terminus-agent-glm-kimi-minimax",
    "shaggyaratia-69/shaggy-agent-megascience-sft1",
    "shaggyaratia-69/Shaggy-Agent-Thinking-GLM-4.7-SFT2",
    "shaggyaratia-69/Shaggy-Agent-Thinking-GLM-4.7-SFT1",
    "shaggyaratia-69/terminal-tasks-glm-shaggy-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "shaggyaratia-69/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload shaggyaratia-69/{output_name} {final_output}")
