...
# Configuration
REPO_URL_SSH="git@github.com:NousResearch/shaggy-agent.git"
REPO_URL_HTTPS="https://github.com/NousResearch/shaggy-agent.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://raw.githubusercontent.com/NousResearch/shaggy-agent/main/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
