#!/usr/bin/env python3
"""Build the Shaggy Skills Index — a centralized JSON catalog of all skills.
...
`shaggy skills search/install` can use it without hitting the GitHub API.
...
# Ensure SHAGGY_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Shaggy Skills Index...", flush=True)
