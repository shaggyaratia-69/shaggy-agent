...
Data file: $SHAGGY_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_SHAGGY_HOME = Path(os.environ.get("SHAGGY_HOME", Path.home() / ".shaggy"))
DATA_DIR = _SHAGGY_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
