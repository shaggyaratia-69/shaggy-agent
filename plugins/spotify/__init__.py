...
``_check_spotify_available()`` — when the user has not run ``shaggy auth
spotify``, the tools remain registered (so they appear in ``shaggy
...
The Spotify auth flow (``shaggy auth spotify``), CLI plumbing, and docs
