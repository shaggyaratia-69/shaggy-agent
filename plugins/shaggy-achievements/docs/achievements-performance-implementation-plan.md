# Shaggy Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.shaggy/plugins/shaggy-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.shaggy/plugins/shaggy-achievements/scan_checkpoint.json`.
