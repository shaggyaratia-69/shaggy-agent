# Shaggy Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.shaggy/plugins/shaggy-achievements/state.json` (existing unlock state)
  - `~/.shaggy/plugins/shaggy-achievements/scan_snapshot.json` (new)
  - `~/.shaggy/plugins/shaggy-achievements/scan_checkpoint.json` (new)
