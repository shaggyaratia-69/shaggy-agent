...
required — uses aiohttp which is already a Shaggy dependency.
...
def interactive_setup() -> None:
    ...
    ``shaggy_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # shaggy_cli/setup.py::_setup_mattermost function.
