"""ntfy platform adapter (Shaggy plugin).
...
``plugins/platforms/ntfy/``. The Shaggy plugin loader scans the
    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "shaggy-in"              # subscribe topic (incoming)
          publish_topic: "shaggy-out"     # optional — defaults to topic
...
_ECHO_TAG = "shaggy-agent"  # tag added to outgoing messages for echo-loop prevention
...
async def _standalone_send(
    ...
    *,
    ...
    ``shaggy cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Shaggy dependency",
