...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the Shaggy Agent documentation based on your experience level and goals.'
---

# Learning Path

Shaggy Agent can do a lot — CLI assistant, Telegram/Discord bot, task automation, RL training, and more. This page helps you figure out where to start and what to read based on your experience level and what you're trying to accomplish.

:::tip Start Here
If you haven't installed Shaggy Agent yet, begin with the [Installation guide](/docs/getting-started/installation) and then run through the [Quickstart](/docs/getting-started/quickstart). Everything below assumes you have a working installation.
:::
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything Shaggy Agent can do.
...
Use Shaggy Agent as an interactive terminal assistant for writing, reviewing, and running code.
...
:::tip
Pass files directly into your conversation with context files. Shaggy Agent can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy Shaggy Agent as a bot on your favorite messaging platform.
...
7. [Use Voice Mode with Shaggy](/docs/guides/use-voice-mode-with-shaggy)
...
:::tip
Cron jobs let Shaggy Agent run tasks on a schedule — daily summaries, periodic checks, automated reports — without you being present.
:::

### "I want to build custom tools/skills"

Extend Shaggy Agent with your own tools and reusable skill packages.

1. [Plugins](/docs/user-guide/features/plugins)
2. [Build a Shaggy Plugin](/docs/guides/build-a-shaggy-plugin)
...
page is for built-in Shaggy core development, not the usual user/custom-tool path.
:::

### "I want to train models"

Use reinforcement learning to fine-tune model behavior with Shaggy Agent's built-in RL training pipeline.
...
:::tip
RL training works best when you already understand the basics of how Shaggy Agent handles conversations and tool calls. Run through the Beginner path first if you're new.
:::

### "I want to use it as a Python library"

Integrate Shaggy Agent into your own Python applications programmatically.
...
| **Code Execution** | Run Python scripts that call Shaggy tools programmatically | [Code Execution](/docs/user-guide/features/code-execution) |
