...
slug: /
sidebar_position: 0
title: "Shaggy Agent Documentation"
description: "The self-improving AI agent built by Cherries and Co. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
| 🔌 **[MCP Integration](/docs/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Shaggy safely |
| 🧭 **[Use MCP with Shaggy](/docs/guides/use-mcp-with-shaggy)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/docs/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Shaggy](/docs/guides/use-voice-mode-with-shaggy)** | Hands-on setup and usage patterns for Shaggy voice workflows |
| 🎭 **[Personality & SOUL.md](/docs/user-guide/features/personality)** | Define Shaggy' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/docs/guides/tips)** | Quick wins to get the most out of Shaggy |
...
- **Built by model trainers** — Created by [Cherries and Co](https://www.cherriesandco.com), the lab behind Shaggy, Nomos, and Psyche. Works with [Nous Portal](https://portal.cherriesandco.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
