...
| | |
|---|---|
| Source | Optional — install with `shaggy skills install official/research/qmd` |
...
Shaggy Agent via the native MCP client. This is the preferred
...
Then configure Shaggy Agent to connect via HTTP:
