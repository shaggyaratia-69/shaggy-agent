...
| | |
|---|---|
| Source | Optional — install with `shaggy skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Shaggy Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $SHAGGY_OSINT_CACHE/icij/ (default: ~/.cache/shaggy-osint/icij/).
...
# Set SHAGGY_OSINT_UA=your-app/1.0 (your@email) to identify yourself
