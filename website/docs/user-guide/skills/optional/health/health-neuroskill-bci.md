...
| | |
|---|---|
| Source | Optional — install with `shaggy skills install official/health/neuroskill-bci` |
...
Connect Shaggy to a running [NeuroSkill](https://neuroskill.com/) instance to read
