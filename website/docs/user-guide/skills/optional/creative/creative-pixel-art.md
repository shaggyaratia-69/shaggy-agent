...
| | |
|---|---|
| Source | Optional — install with `shaggy skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.shaggy/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.shaggy/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Shaggy installs package this)
