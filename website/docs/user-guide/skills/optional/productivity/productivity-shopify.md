...
| | |
|---|---|
| Source | Optional — install with `shaggy skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Shaggy","productType":"Apparel","tags":["test"]}}'
```
