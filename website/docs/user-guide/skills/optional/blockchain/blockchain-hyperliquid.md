...
| | |
|---|---|
| Source | Optional — install with `shaggy skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Shaggy Agent |
| License | MIT |
...
The script reads `~/.shaggy/.env` for two optional defaults:
...
Helper script: `~/.shaggy/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.shaggy/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.shaggy/.env`.
...
```bash
python3 ~/.shaggy/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.shaggy/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
