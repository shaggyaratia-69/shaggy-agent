...
| | |
|---|---|
| Source | Optional — install with `shaggy skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Shaggy Agent |
| License | MIT |
...
```
SCRIPT=~/.shaggy/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.shaggy/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
