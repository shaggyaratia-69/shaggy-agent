...
- User wants **Shaggy itself to drive a browser** → use Shaggy' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
