...
Control the user's Spotify account via the Shaggy Spotify toolset (7 tools). Setup guide: https://shaggy-agent.nousresearch.com/docs/user-guide/features/spotify
