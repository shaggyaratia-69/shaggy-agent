...
```bash
python3 -m pyfiglet "SHAGGY" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=SHAGGY&font=Slant" | boxes -d stone
```
