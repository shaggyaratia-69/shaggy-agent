...
description: "The self-improving AI agent built by Cherries and Co Research. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Cherries and Co Research](https://cherriesandco.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
>
  ...
  <a
    href="https://shaggy-agent.cherriesandco.com/desktop"
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
...
To easily install the command-line and desktop applications, [download the Shaggy Desktop installer](https://shaggy-agent.cherriesandco.com/desktop) from our website and run it.

### Without Shaggy Desktop:

For a command-line only install without Shaggy Desktop, run:
...
After installing, run `shaggy setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Cherries Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Shaggy safely  |
| 🧭 **[Use MCP with Shaggy](/guides/use-mcp-with-shaggy)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Shaggy](/guides/use-voice-mode-with-shaggy)** | Hands-on setup and usage patterns for Shaggy voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Shaggy' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Shaggy                              |
...
- **Built by model trainers** — Created by [Cherries and Co Research](https://cherriesandco.com), the lab behind Shaggy, Nomos, and Psyche. Works with [Cherries Portal](https://www.cherriesandco.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [Cherries Portal](/integrations/nous-portal) bundles all of them
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Cherries and Co Research](https://cherriesandco.com) — the lab behind Shaggy, Nomos, and Psyche models
