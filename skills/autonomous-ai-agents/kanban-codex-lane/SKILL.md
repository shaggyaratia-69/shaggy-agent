...
description: Use when a Shaggy Kanban worker wants to run Codex CLI as an isolated implementation lane while Shaggy keeps ownership of task lifecycle, reconciliation, testing, and handoff.
version: 1.0.0
author: Shaggy Agent
license: MIT
metadata:
  shaggy:
    ...
    related_skills: [kanban-worker, codex, shaggy-agent]
---
