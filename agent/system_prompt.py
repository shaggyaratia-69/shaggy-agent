...
upstream prefix cache warm.  See ``shaggy-agent-dev``'s
...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Shaggy never re-renders parts of this string mid-
    ...
    # Some execution modes (cron) still want SHAGGY_HOME persona while keeping
    ...
    # Pointer to the shaggy-agent skill + docs for user questions about Shaggy itself.
    stable_parts.append(SHAGGY_AGENT_HELP_GUIDANCE)
    ...
    # SHAGGY_KANBAN_TASK env var). Normal chat sessions never see
    ...
    if not agent.skip_context_files:
        ...
        # mode).  The gateway process runs from the shaggy-agent install
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — Shaggy never rebuilds or reinjects parts of it
