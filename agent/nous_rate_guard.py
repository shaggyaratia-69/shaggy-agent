...
(3 SDK retries x 3 Shaggy retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_shaggy_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".shaggy")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Shaggy, ...) behind one endpoint.  A 429 can mean either:
