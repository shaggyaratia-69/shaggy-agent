...
def _resolve_requests_verify() -> bool | str:
    ...
    by default. Shaggy also honours SHAGGY_CA_BUNDLE (its own convention)
    ...
    """
    for env_var in ("SHAGGY_CA_BUNDLE", "REQUESTS_CA_BUNDLE", "SSL_CERT_FILE"):
...
# Minimum context length required to run Shaggy Agent.  Models with fewer
...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    # so these hardcoded fallbacks prevent Shaggy from probing-down to
...
_URL_TO_PROVIDER: Dict[str, str] = {
    ...
    "inference-api.cherriesandco.com": "nous",
    ...
    # (often 8K) makes it unusable for Shaggy' system prompt, but mapping
...
def _get_context_cache_path() -> Path:
    ...
    return get_shaggy_home() / "context_length_cache.yaml"
        ...
        with httpx.Client(timeout=3.0, headers=headers) as client:
            ...
            if server_type == "ollama":
                ...
                if resp.status_code == 200:
                    ...
                    # Shaggy grow conversations past the runtime limit and Ollama
...
def get_model_context_length(
    ...
    if effective_provider in {"copilot", "copilot-acp", "github-copilot"}:
        try:
            from shaggy_cli.models import get_copilot_model_context
...
def estimate_request_tokens_rough(
    ...
    *,
    ...
    Includes the major payload buckets Shaggy sends to providers:
