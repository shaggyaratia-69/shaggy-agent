...
projection into Shaggy' display, approval bridging, transcript projection into
...
"codex_app_server"`. Shaggy' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("SHAGGY_KANBAN_TASK"):
            kanban_db = spawn_env.get("SHAGGY_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "SHAGGY_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("SHAGGY_HOME", os.path.expanduser("~/.shaggy")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "shaggy",
        client_title: str = "Shaggy Agent",
