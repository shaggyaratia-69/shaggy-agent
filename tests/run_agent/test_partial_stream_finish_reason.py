...
from shaggy_constants import PARTIAL_STREAM_STUB_ID, FINISH_REASON_LENGTH
...
class TestPartialStreamStubFinishReason:
    ...
    def test_text_only_partial_returns_length(self, _mock_close, mock_create, monkeypatch):
        ...
        monkeypatch.setenv("SHAGGY_STREAM_RETRIES", "0")
...
class TestCleanStreamEndMidToolCall:
    ...
    NO [DONE].  Observed live on NVIDIA Nemotron Ultra via the Cherries dedicated
