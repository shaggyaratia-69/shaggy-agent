...
def worker_loop(worker_id: int, shaggy_home: str, result_file: str) -> None:
...
def reclaimer_loop(shaggy_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="shaggy_mixed_stress_")
    print(f"SHAGGY_HOME = {home}")
