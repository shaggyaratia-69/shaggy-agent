...
The unit tests in tests/shaggy_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned shaggy-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/shaggy")
from shaggy_cli.service_manager import S6ServiceManager
