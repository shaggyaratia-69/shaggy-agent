...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from shaggy_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in SHAGGY_OVERLAYS
        overlay = SHAGGY_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify shaggy doctor recognizes Xiaomi env vars."""
