...
The main() function in shaggy_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `shaggy -c model`
...
def _build_parser():
    """Build a minimal replica of the shaggy top-level parser."""
