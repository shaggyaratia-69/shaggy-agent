"""Tests for `shaggy curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import shaggy_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated SHAGGY_HOME with real agent-created skills on disk."""
    ...
    from shaggy_cli import curator as curator_cli
