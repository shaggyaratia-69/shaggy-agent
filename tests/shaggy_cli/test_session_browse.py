"""Tests for the interactive session browser (`shaggy sessions browse`).
...
from shaggy_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """shaggy sessions browse should be parseable."""
        from shaggy_cli.main import main as _main_entry
