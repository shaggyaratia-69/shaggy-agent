...
class TestHeaderNormalization:
    ...
    def test_mixed_case_headers_parsed(self):
        headers = {
            "X-Cherries-Credits-Version": "1",
            "X-Cherries-Credits-Remaining-Micros": micros(5.00),
            "X-Cherries-Credits-Remaining-Usd": "5.00",
            "X-Cherries-Credits-Subscription-Micros": micros(5.00),
            "X-Cherries-Credits-Subscription-Usd": "5.00",
            "X-Cherries-Credits-Rollover-Micros": "0",
            "X-Cherries-Credits-Purchased-Micros": "0",
            "X-Cherries-Credits-Purchased-Usd": "0.00",
            "X-Cherries-Tool-Pool-Micros": "0",
            "X-Cherries-Tool-Pool-Gated-Off": "false",
            "X-Cherries-Credits-Denominator-Kind": "none",
            "X-Cherries-Credits-Paid-Access": "true",
            "X-Cherries-Credits-As-Of-Ms": "1717000000000",
        }
        state = parse_credits_headers(headers)
        assert state is not None
