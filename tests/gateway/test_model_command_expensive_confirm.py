...
def _fake_warning():
    return SimpleNamespace(
        message=(
            ...
            "openai/gpt-5.5-pro has known pricing above Shaggy' safety threshold.\n"
...
def _setup_isolated_home(tmp_path, monkeypatch, *, warn):
    ...
    monkeypatch.setattr(
        "shaggy_cli.model_switch.switch_model",
        lambda **kw: _fake_switch_result(),
    )
    monkeypatch.setattr("shaggy_constants.get_shaggy_home", lambda: shaggy_home)
    monkeypatch.setattr("shaggy_cli.config.get_shaggy_home", lambda: shaggy_home)
    monkeypatch.setattr(
        "shaggy_cli.model_cost_guard.expensive_model_warning",
