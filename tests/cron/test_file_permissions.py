...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("shaggy_cli.config.get_config_path", return_value=config_path), \
             patch("shaggy_cli.config.ensure_shaggy_home"):
    ...
    def test_ensure_shaggy_home_sets_0700(self):
        home = Path(self.tmpdir) / ".shaggy"
        with patch("shaggy_cli.config.get_shaggy_home", return_value=home):
