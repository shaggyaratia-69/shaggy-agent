...
def auth_json_path():
    """Return the Shaggy auth store path, respecting SHAGGY_HOME overrides."""
    return get_shaggy_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from shaggy_cli.auth import resolve_nous_access_token
