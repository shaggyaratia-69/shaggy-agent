...
the get_anchored_view / get_messages_around primitives in shaggy_state.
...
# Third-party integrations tag their sessions with SHAGGY_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from shaggy_state import DEFAULT_DB_PATH
