...
Trust levels:
  - builtin:   Ships with Shaggy. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.shaggy/\.env|\~/\.shaggy/\.env',
     "shaggy_env_access", "critical", "exfiltration",
     "directly references Shaggy secrets file"),
    ...
    (r'\.shaggy/config\.yaml|\.shaggy/SOUL\.md',
     "shaggy_config_mod", "critical", "persistence",
     "references Shaggy configuration files directly"),
