...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateShaggy: "Shaggy aktualisieren",
    updatingShaggy: "Shaggy wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "Shaggy-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `shaggy plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.shaggy/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.shaggy/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.shaggy/skills/ geladen",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare Shaggy-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "Shaggy-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze Shaggy mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Shaggy ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "Shaggy scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
