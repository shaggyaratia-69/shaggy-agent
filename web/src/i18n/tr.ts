...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateShaggy: "Shaggy'i Güncelle",
    updatingShaggy: "Shaggy güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "Shaggy eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`shaggy plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.shaggy/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.shaggy/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.shaggy/skills/ adresinden yüklenir",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk Shaggy rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "Shaggy oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "Shaggy'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. Shaggy ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "Shaggy yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
