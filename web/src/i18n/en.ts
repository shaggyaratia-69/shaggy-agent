...
export const en: Translations = {
  ...
  status: {
    ...
    updatingShaggy: "Updating Shaggy…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Shaggy plugins (`shaggy plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.shaggy/plugins/?",
    removeHint: "Only user-installed plugins under ~/.shaggy/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.shaggy/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Shaggy badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Shaggy session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Shaggy more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Shaggy sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Shaggy is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
