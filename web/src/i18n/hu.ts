...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateShaggy: "Shaggy frissítése",
    updatingShaggy: "Shaggy frissítése…",
  ...
  pluginsPage: {
    ...
    headline:
      "Shaggy-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `shaggy plugins` paritás).",
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.shaggy/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.shaggy/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.shaggy/skills/ mappából töltődnek be",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gyűjthető Shaggy-jelvények, valós munkamenet-előzmények alapján szerezve. Az ismert, de még nem szerzett teljesítmények Felfedezettként jelennek meg; a Titkos teljesítmények rejtve maradnak az első egyező viselkedésig.",
      scan_subtitle:
        "Shaggy munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Legutóbbi",
      latest_hint_empty: "futtasd többet a Shaggyt",
      none_yet: "Még semmi",
    },
    state: {
      unlocked: "Feloldva",
    ...
    guide: {
      ...
      secret_body:
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint a Shaggy kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",
      scan_status_header: "Vizsgálat állapota",
      scan_status_body:
        "A Shaggy egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",
