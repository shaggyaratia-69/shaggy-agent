...
const STORAGE_KEY = "shaggy-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `shaggy_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "shaggy-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-shaggy-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-shaggy-theme-font", "true");
