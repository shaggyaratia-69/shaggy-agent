...
import type { ScrollBoxHandle } from '@shaggy/ink'
import { evictInkCaches } from '@shaggy/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.SHAGGY_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
