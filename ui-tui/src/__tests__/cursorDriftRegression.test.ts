 ...
 *
 * Symptom: in `shaggy --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@shaggy/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using shaggy --tui and as i type multiline my caret at the end will often ' +
